...
function display() {
    ...
    for(var i=0; i<elements.length; i++)
        document.querySelector(".list").innerHTML += "<center><div class='element'>" + elements[i] + "<img class='tick' src='ticks.jpg' onclick='strike("+i+")'> <img class='trash' src='Trash_icon.png' onclick='del("+i+")'></div></center>" ;
